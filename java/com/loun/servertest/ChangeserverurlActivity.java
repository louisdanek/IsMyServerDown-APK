...
public class ChangeserverurlActivity extends AppCompatActivity {
	...
	protected void onCreate(Bundle _savedInstanceState) {
		...
		setContentView(R.layout.changeserverurl);
	...
	private void initialize(Bundle _savedInstanceState) {
		...
		button1.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View _view) {
				serverurl.edit().putString("serverurl", editserverurl.getText().toString()).commit();
	...
	private void initializeLogic() {
		if (serverurl.getString("serverurl", "").equals("")) {
			...
			editserverurl.setText(serverurl.getString("serverurl", ""));
		}
	}
